...
export const PROJECTS: Project[] = [
    {
      ...
      body: "Stay updated on the latest tech trends with our News App. The homepage, skillfully crafted with React and stylized with Sass, promises a visually appealing and user-friendly journey across various devices. Explore the future of technology with our responsive and innovative news platform.",
      url: null,
      published_date: null,
      image: null,
      thumb: null,
    ...
    },
    {
      ...
      body: "Take control of billing processes effortlessly with Express Billing, a MERN stack application. User roles, secure authentication, and MongoDB ensure a powerful and scalable solution for efficient data management. Experience the convenience of streamlined billing operations with our feature-rich application.",
      url: null,
      published_date: null,
      image: null,
      thumb: null,
    ...
    },
    {
      ...
      body: "Step into the world of Responsive Images, a website designed to captivate users with visually stunning content. Each image adapts seamlessly to different device widths, providing an immersive and responsive user experience. Explore the beauty of adaptability with our collection of visually arresting images.",
      url: null,
      published_date: null,
      image: null,
      thumb: null,
    ...
    },
    {
      ...
      body: "Discover the allure of Novella, an e-commerce platform dedicated to the artistry of necklace design. Immerse yourself in a seamless shopping experience, powered by C# and MVC architecture, with robust SQL data management and secure PayPal integration. Adorn yourself with exquisite necklaces and make a fashion statement with Novella.",
      url: null,
      published_date: null,
      image: null,
      thumb: null,
    ...
    },
    {
      ...
      body: "Transform your banking experience with our C#-powered Banking App. View account balances, make deposits, and withdrawals with utmost ease and security. Empower your financial journey with the convenience of our user-friendly and feature-rich Banking App.",
      url: null,
      published_date: null,
      image: null,
      thumb: null,
